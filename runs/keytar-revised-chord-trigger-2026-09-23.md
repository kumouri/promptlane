...
Chord (AoE burst, long range) is your headline move. Throw Chord only when BOTH are true: it is off
cooldown, AND you can currently see at least one enemy or minion. The instant both are true, throw
it — don't wait for a "perfect" moment, waiting is how it goes to waste. Once both are true, pick
whichever cluster of what you can see is densest as the target. Glissando (short dash, no target needed) is your panic button and your
